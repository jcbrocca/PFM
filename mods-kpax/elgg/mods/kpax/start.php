...
function kpax_page_handler($page) {
    ...
    elgg_push_breadcrumb(elgg_echo('kPAX:delete'), 'kpax/delete'); //jcbrocca - ccamera
    elgg_push_breadcrumb(elgg_echo('kPAX:find'), 'kpax/find'); //jcb
...
function kpax_url($entity) {
    ...
    return $CONFIG->url . "kpax/view/" . $entity->getGUID() . "/" . $title; //retornado original jcbrocca - ccamera
}
